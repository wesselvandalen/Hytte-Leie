...
interface CabinFilterProps {
    ...
    setMaxGuests: (value: number | null) => void;
    location: string;
    setLocation: (value: string) => void;
}

export default function CabinFilter({ maxGuests, setMaxGuests, location, setLocation }: CabinFilterProps) {
    return (
            ...
            <div className="filter-box-content">
                <div className='filter'>
                    ...
                    <input 
                        ...
                        value={maxGuests ?? ""}
                        onChange={(e) =>
                            setMaxGuests(e.target.value ? parseInt(e.target.value) : null)
                        } />
                </div>
                <p>|</p>
                <div className='filter'>
